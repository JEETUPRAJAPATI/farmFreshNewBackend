...
export const getAllFarmers = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to fetch farmers", error: String(error) });
  }
};
...
export const getFarmerById = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to fetch farmer", error: String(error) });
  }
};
...
export const createFarmer = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to create farmer", error: String(error) });
  }
};
...
export const updateFarmer = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to update farmer", error: String(error) });
  }
};
...
export const toggleFarmerFeatured = async (req: Request, res: Response) => {
  try {
    ...
    if (typeof featured !== "boolean") {
      return res
        .status(400)
        .json({ message: "Featured status must be a boolean" });
    }
    ...
    res
      .status(500)
      .json({
        message: "Failed to update farmer featured status",
        error: String(error),
      });
  }
};
...
export const deleteFarmer = async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Failed to delete farmer", error: String(error) });
  }
};
